      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            <div className="text-2xl script-font font-bold">
              <div className="text-sm text-center">🌸</div>
              Fancy Florist
            </div>
            <p className="text-gray-300 text-sm">
              Boutique floral studio in Phnom Penh, specializing in luxury arrangements with premium, exquisite blooms.
            </p>
          </div>
        ...
        <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300 text-sm">
            © 2024 Fancy Florist. All rights reserved.
          </p>
